...
function doSorakaStarcall()
	...
	if config.autoStarcall.towerDive == UnderTurret(player, true) and hitEnemy then return end
	-- Minion Calculations
	enemyMinions:update()
...
function doSorakaSilence()
	if config.autoSilence.towerDive == UnderTurret(player, true) then return end
...
function drawMenu()
	-- Config Menu
	config = scriptConfig("Unified Soraka", "Unified Soraka")	
	...
	config.autoStarcall:addParam("towerDive", "Starcall Under Towers", SCRIPT_PARAM_ONOFF, false)
	...
	config.autoSilence:addParam("towerDive", "Silence Under Towers", SCRIPT_PARAM_ONOFF, false)
...
function OnCreateObj(obj)
	...
	if obj.name == "TeleportHomeImproved.troy" or obj.name == "TeleportHome.troy" then
